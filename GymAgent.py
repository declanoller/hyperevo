...
class GymAgent:
    ...
    def __init__(self, **kwargs):
        ...
        # Create the env
        env_obj = kwargs.get('env_obj', None)
        self.makeEnv(env_obj)
        ...
        self.render_type = 'gym'



    def makeEnv(self, env_obj):
        # This uses an env object if one is passed to it, and creates
        # one if one isn't passed.
